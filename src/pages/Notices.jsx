...
const notices = [
  ...
  },
  {
    ...
    title: "रचनाकारों से रचनाएं आमंत्रित",
    description:
      "साहित्यिक रचनाकारों से मौलिक रचनाएं आमंत्रित की जा रही हैं।",
    date: "25 अगस्त 2026",
    link: "",
  },
  {
    ...
    title: "चौखट परिवार में नए सदस्य",
    description:
      "चौखट के साहित्यिक परिवार से जुड़े नए सदस्यों का स्वागत है।",
    date: "20 अगस्त 2026",
    link: "",
  },
  {
        ...
        >
          {notices.map((notice, index) => {
            ...
            const isExternalLink =
              hasLink &&
              /^(https?:\/\/|mailto:|tel:)/i.test(notice.link);
